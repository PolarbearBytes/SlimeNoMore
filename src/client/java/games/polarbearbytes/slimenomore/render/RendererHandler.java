...
public class RendererHandler {
    ...
    public void renderLast(Matrix4f positionMatrix, Matrix4f projectionMatrix, MinecraftClient client,
        ...
        if(!SlimeNoMoreClient.renderDisabledDisplay || renderers.isEmpty()) return;

        FramePass pass = frameGraphBuilder.createPass(SlimeNoMore.MOD_ID+"_worldrenderer_last_render");
